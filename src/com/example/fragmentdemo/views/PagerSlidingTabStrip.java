...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs,
		...
		dividerWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP,
				dividerWidth, dm);
	...
	private void addTab(final int position, CharSequence title, int iconResId,
			int iLayoutResId, int iTextId, int iIconLocation) {
	...
	protected void onDraw(Canvas canvas) {
		...
		float lineLeft = currentTab.getLeft() + iLinePadding;
		...
		if (currentPositionOffset > 0f && currentPosition < tabCount - 1) {
			...
			final float nextTabLeft = nextTab.getLeft() + iLinePadding;
