 ...
 */
package com.example.fragmentdemo.viewflow;
...
public class CircleFlowIndicator extends View implements FlowIndicator,
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		// Retrieve the radius
		radius = a.getDimension(R.styleable.CircleFlowIndicator_radiusDimens, 4.0f);
	...
	private void initColors(int activeColor, int inactiveColor, int activeType,
		...
		default:
			...
			mPaintInactive.setStrokeWidth(4);
		}
...
//	private void initDrawable(int activeDrawable, int inactiveDrawable, int activeType,
//			int inactiveType) {
//		// Select the paint type given the type attr
//		switch (inactiveType) {
//		case STYLE_FILL:
...
//	}
	...
	protected void onDraw(Canvas canvas) {
		...
		// Bitmap bitmap=getResources().getDrawable(id)
